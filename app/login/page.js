...
const page = () => {
  ...
  return (
    <>
      <div className="login container mx-auto flex flex-col justify-center items-center">
        <h1 className="text-center md:text-3xl text-2xl font-bold my-12  md:w-full w-11/12">
          Login to Get <span className="text-[#FFC107]">Started</span>
        </h1>
        <div className="social-login-btn flex flex-col gap-4 md:mb-[6.65rem] mb-[10.25rem] p-10">
          <button
            className="flex items-center border border-gray-300 rounded-lg shadow-md maxW-xs py-2 text-sm font-medium hover:bg-indigo-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 hover:text-black w-full justify-between px-20 bg-slate-100 text-black"
